...
public class TelaCadMarca extends javax.swing.JFrame {
    ...
    public Marca criarObjeto() {
        marca = new Marca();
        marca.setNomeMarca(JTFMarca.getText());
        if (JTFCodigo.getText().equals("")) {
        }else{
            marca.setIdMarca(Integer.parseInt(JTFCodigo.getText()));
        }
        return marca;
    }
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)))
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(JTFMarca, javax.swing.GroupLayout.PREFERRED_SIZE, 478, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void JTFMarcaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JTFMarcaMouseClicked
        ...
        JTFMarca.setText("");// TODO add your handling code here:
    ...
    private void JBNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBNovoActionPerformed
        habilitarCampus(2);
        limparCampus();
        JTFCodigo.setText(Integer.toString(controller.pegarIdMarca()+1));
 ...
 private void pesquisar() {
        marca = controller.pesquisar(JTFPesquisar.getText());
        if (marca.getIdMarca()== 0) {
            ...
            JTFCodigo.setText(Integer.toString(marca.getIdMarca()));
            JTFMarca.setText(marca.getNomeMarca());
            habilitarCampus(1);
        }
    }
    ...
    public boolean verificarCampus(){
        ...
        if (JTFMarca.getText().isEmpty()){
            JTFMarca.setText("O campa Marca não pode ficar vazio");
            JTFMarca.setBackground(Color.red);
            preechido = false;
        }
        return preechido;
    }
