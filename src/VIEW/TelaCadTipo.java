 ...
 * @author wesley
 */
public class TelaCadTipo extends javax.swing.JFrame {
    ...
    public Tipo criarObjeto() {
        tipo = new Tipo();
        tipo.setNomeTipo(JTFTipo.getText());
        if (JTFCodigo.getText().equals("")) {
        }else{
            tipo.setIdTipo(Integer.parseInt(JTFCodigo.getText()));
        }
        return tipo;
    }
    ...
    private void JTFTipoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JTFTipoMouseClicked
        ...
        JTFTipo.setText("");// TODO add your handling code here:
    ...
    private void JBNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBNovoActionPerformed
        habilitarCampus(2);
        limparCampus();
        JTFCodigo.setText(Integer.toString(controller.pegarIdTipo()+1));
    ...
    private void JBAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBAlterarActionPerformed
        int opcao = JOptionPane.showConfirmDialog(null, "Deseja realmente atualizar os dados do Tipo?", "Mensagem do Sistema", JOptionPane.INFORMATION_MESSAGE);
        // TODO add your handling code here:
        if (opcao == 0) {
            if (verificarCampus()) {
    ...
    private void JBExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBExcluirActionPerformed
        int opcao = JOptionPane.showConfirmDialog(null, "Deseja realmente excluir o Tipo?", "Mensagem do Sistema", JOptionPane.INFORMATION_MESSAGE);
        if (opcao == 0) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCadTipo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCadTipo().setVisible(true);
            }
        });
    }
 ...
 private void pesquisar() {
        tipo = controller.pesquisar(JTFPesquisar.getText());
        if (tipo.getIdTipo()== 0) {
            this.habilitarCampus(3);
            JOptionPane.showMessageDialog(null, "Tipo não encontrada","Mensagem do Sistema",JOptionPane.INFORMATION_MESSAGE);         
        } else {
            JTFCodigo.setText(Integer.toString(tipo.getIdTipo()));
            JTFTipo.setText(tipo.getNomeTipo());
            habilitarCampus(1);
        }
    }
    ...
    public boolean verificarCampus(){
        ...
        if (JTFTipo.getText().isEmpty()){
            JTFTipo.setText("O campo Tipo não pode ficar vazio");
            JTFTipo.setBackground(Color.red);
            preechido = false;
        }
        return preechido;
    }
